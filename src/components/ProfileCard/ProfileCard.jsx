...
const DatingCard = (props) => {
    ...
    async function flyAway(min){
        ...
        if (direction && Math.abs(velocity) > min) {
            ...
            props.removeProfile(props.user_id)
        }
    }
    ...
    async function handleCardBtn(event, isLiked){
        if(isLiked)
    ...
    const handleCardClick = (event)=>{
        ...
        if(newIdx >= 0 && newIdx < props.img_urls.length){
    ...
    return(
        ...
        >
            <Card className="disable-select" style={{
                backgroundImage: `linear-gradient(to top, rgb(0, 0, 0), rgb(0, 0, 0, 0.3), transparent, transparent), url('${props.img_urls[currentImg]}')`,
                ...
                <div className="img-indicator" style={{
                    ...
                    {
                     props.img_urls.map((value, idx) => <div className="img-indicator" style={{
                            width: "100%",
                            height: "6px",
                            borderRadius:"5px",
                ...
                {props.img_urls.length > 1 && <div className = "card-indicator">
                ...
                <Card.Body>
                <Card.Title>
                    <span className="name disable-select">{props.name}</span>
                    <span className="age disable-select">{props.age}</span>
                </Card.Title>

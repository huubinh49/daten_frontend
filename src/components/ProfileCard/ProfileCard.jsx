        ...
        >
            <Card className="disable-select" style={{
                ...
                <Card.Text className = "disable-select">
                    ...
                    <span className = "disable-select">{props.profile.work}</span>
                </Card.Text> 
                <Card.Text className = "disable-select">
                    ...
                    <span className = "disable-select">Lives in {props.profile.address}</span>
                </Card.Text> 
                <Card.Text className = "disable-select">
                    ...
                    <span className = "disable-select">{props.profile.distance} kilometers away</span>
                </Card.Text>
                <Card.Text>
                    {props.profile.bio}
                </Card.Text>
